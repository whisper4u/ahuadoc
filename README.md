...
**话先说在前面，GKI模式（特别是能用KPM模块的）恢复出厂设置有小概率机器会砖，请做好变砖的心理准备，变砖了可以找我远程或者邮寄刷好**
...
<span style="color: red;">视频教程已上传至网盘5号文件夹，如果看不懂图文可以直接看视频操作！！</span><br >
<span style="color: red;">视频教程已上传至网盘5号文件夹，如果看不懂图文可以直接看视频操作！！</span><br >
<span style="color: red;">视频教程已上传至网盘5号文件夹，如果看不懂图文可以直接看视频操作！！</span><br >
<span style="color: red;">视频教程已上传至网盘5号文件夹，如果看不懂图文可以直接看视频操作！！</span><br >
...
强烈建议恢复出厂设置后使用，可达到最佳效果，目前测试绝大部分机型都可完美过环境。若实在不行，去MT删除data/adb内所有文件重启后再刷入一键包（注：此操作会删除所有现有模块和面具设置，**阿尔法&Magisk面具请先进面具设置还原magisk再删除data/adb**）
...
开发者模式：一般在设置-关于本机里，找到”版本信息“或”系统版本“，连续点击此项后，底部会提示开发者模式已启用，此时已打开开发者，继续下一步操作

USB调试：启用开发者后，在设置里搜索"usb调试"或“开发者”即可，小米的机器需要额外打开"usb调试（安全设置）"，打开时需要插卡联网登录账号
...
另外，有部分App初次打开时可能会申请获取应用列表权限，**不要给这个App获取应用列表权限，或者申请时允许，然后用隐藏应用列表App对其启用并配置好**
...
[点击查看如何打开“USB调试“或“开发者模式”](#如何打开USB调试或开发者模式)
